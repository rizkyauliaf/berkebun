...
<head>
  ...
  <title>Agrowisata</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="{{asset('pengunjung/assets/img/favicon.png')}}" rel="icon">
  <link href="{{asset('pengunjung/assets/img/apple-touch-icon.png')}}" rel="apple-touch-icon">
  ...
  <link href="{{asset('pengunjung/assets/css/main.css')}}" rel="stylesheet">
</head>
